...
import { deleteItem, getAllDataList, setCurrentPage, setPageLimit, setSearchParam } from "@/store/slice/commonSlice";
import { setDeleteSalesDialog, setSalesTableData } from "@/store/slice/salesSlice";
...
const SalesListing = () => {
    ...
    const { allSalesListData, deleteSalesDialog } = useSelector(({ sales }) => sales)
