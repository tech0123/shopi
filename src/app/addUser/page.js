        ...
        <div>
            ...
            <Dialog visible={productDialog} style={{ width: '32rem' }} breakpoints={{ '960px': '75vw', '641px': '90vw' }} header="Product Details" modal className="p-fluid" footer={productDialogFooter} onHide={hideDialog}>
                ...
                <div className="field">
                    ...
                    <InputTextarea id="address" value={product.address} onChange={(e) => onInputChange(e, 'address')} required rows={3} cols={20} />
                ...
                <div className="field">
                    ...
                    <InputText id="mobileNo" value={product.mobileNo} onChange={(e) => onInputChange(e, 'mobileNo')} required autoFocus className={classNames({ 'p-invalid': submitted && !product.mobileNo })} />
                    {submitted && !product.mobileNo && <small className="p-error">Mobile Number is required.</small>}
                </div>
                <div className="field">
                    <label htmlFor="shopName" className="font-bold">
                        Shop Name
                    </label>
                    <InputText id="shopName" value={product.shopName} onChange={(e) => onInputChange(e, 'shopName')} required autoFocus className={classNames({ 'p-invalid': submitted && !product.shopName })} />
                    {submitted && !product.shopName && <small className="p-error">Shop Name is required.</small>}
                </div>
                <div className="field">
                    <label htmlFor="gstNo" className="font-bold">
                        GST No
                    </label>
                    <InputText id="gstNo" value={product.gstNo} onChange={(e) => onInputChange(e, 'gstNo')} required autoFocus className={classNames({ 'p-invalid': submitted && !product.gstNo })} />
                    {submitted && !product.gstNo && <small className="p-error">GST No is required.</small>}
                </div>
